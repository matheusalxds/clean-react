...
describe('Login', () => {
  ...
  it('should present error state if form is invalid', () => {
    ...
    cy.getByTestId('password-wrap').should('have.attr', 'data-status', 'invalid')
    cy.getByTestId('password').should('have.attr', 'title', 'O campo min-length é invalido')
    cy.getByTestId('password-label').should('have.attr', 'title', 'O campo min-length é invalido')
